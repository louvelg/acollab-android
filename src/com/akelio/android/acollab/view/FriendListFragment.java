...
//
//					String faceName = CursorUtils.getString(
//							FriendContentProvider.FACE_COLUMN, paramCursor);
//					String friendName = CursorUtils.getString(
//							FriendContentProvider.NAME_COLUMN, paramCursor);
//					Drawable face = ResourceUtils.getDrawableByName(faceName,
...
//				FriendContentProvider.NAME_COLUMN,
...
//	}
	...
	public void onResume() {
		...
		if (this.getListView().getSelectedView() != null) {
			ensureVisible(this.getListView(), this.getListView()
					.getSelectedView());
		}
	}
	...
	private void ensureVisible(ListView parent, View view) {
		...
		// Rect rect = new Rect(view.getLeft(), view.getTop(), view.getRight(),
		// view.getBottom());
...
//					R.id.friendmain_fragment, this.getParentFragment()
//							.getChildFragmentManager());
//		} else {
//			FragmentHelper.initFragment(detailFragment,
//					R.id.frienddetail_fragment, this.getParentFragment()
//							.getChildFragmentManager());
//		}
	}
}
