...
//		if (!this.dualPanel) {
			getFragmentManager().beginTransaction().replace(R.id.content_frame, new TaskListFragment()).addToBackStack(null).commit();
	...
	private class BigCalcul extends AsyncTask<Void, Integer, Void> {
		...
		protected Void doInBackground(Void... arg0) {
			...
			for (progress = 0; progress <= 100; progress++) {
				...
				// la m�thode publishProgress met � jour l'interface en invoquant la m�thode onProgressUpdate
